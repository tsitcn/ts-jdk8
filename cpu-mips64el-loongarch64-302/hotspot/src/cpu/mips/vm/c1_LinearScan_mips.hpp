...
#ifndef CPU_MIPS_VM_C1_LINEARSCAN_MIPS_HPP
...
inline bool LinearScanWalker::pd_init_regs_for_alloc(Interval* cur) {
  if (allocator()->gen()->is_vreg_flag_set(cur->reg_num(), LIRGenerator::callee_saved)) {
    ...
    return true;
  } else if (cur->type() == T_INT || cur->type() == T_LONG || cur->type() == T_OBJECT || cur->type() == T_METADATA) {
#ifdef _LP64
...
#endif // CPU_MIPS_VM_C1_LINEARSCAN_MIPS_HPP
