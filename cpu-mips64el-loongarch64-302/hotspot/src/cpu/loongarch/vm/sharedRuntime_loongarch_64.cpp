...
#define DEF_LAYOUT_OFFS(regname)  regname ## _off,  regname ## H_off,
  ...
  static int v0Offset(void) { return a0_off / 2; }
  static int v1Offset(void) { return a1_off / 2; }
  static int t5Offset(void) { return t5_off / 2; }
...
OopMap* RegisterSaver::save_live_registers(MacroAssembler* masm, int additional_frame_words, int* total_frame_words, bool save_vectors ) {
  ...
  *total_frame_words = frame_size_in_words;
  ...
  // save registers
  __ addi_d(SP, SP, - reg_save_size * jintSize);

  __ fst_d(F0, SP, fpr0_off * jintSize); __ fst_d(F1, SP, fpr1_off * jintSize);
  __ fst_d(F2, SP, fpr2_off * jintSize); __ fst_d(F3, SP, fpr3_off * jintSize);
  __ fst_d(F4, SP, fpr4_off * jintSize); __ fst_d(F5, SP, fpr5_off * jintSize);
  __ fst_d(F6, SP, fpr6_off * jintSize);  __ fst_d(F7, SP, fpr7_off * jintSize);
  __ fst_d(F8, SP, fpr8_off * jintSize);  __ fst_d(F9, SP, fpr9_off * jintSize);
  __ fst_d(F10, SP, fpr10_off * jintSize);  __ fst_d(F11, SP, fpr11_off * jintSize);
  __ fst_d(F12, SP, fpr12_off * jintSize);  __ fst_d(F13, SP, fpr13_off * jintSize);
  __ fst_d(F14, SP, fpr14_off * jintSize);  __ fst_d(F15, SP, fpr15_off * jintSize);
  __ fst_d(F16, SP, fpr16_off * jintSize);  __ fst_d(F17, SP, fpr17_off * jintSize);
  __ fst_d(F18, SP, fpr18_off * jintSize);  __ fst_d(F19, SP, fpr19_off * jintSize);
  __ fst_d(F20, SP, fpr20_off * jintSize);  __ fst_d(F21, SP, fpr21_off * jintSize);
  __ fst_d(F22, SP, fpr22_off * jintSize);  __ fst_d(F23, SP, fpr23_off * jintSize);
  __ fst_d(F24, SP, fpr24_off * jintSize);  __ fst_d(F25, SP, fpr25_off * jintSize);
  __ fst_d(F26, SP, fpr26_off * jintSize);  __ fst_d(F27, SP, fpr27_off * jintSize);
  __ fst_d(F28, SP, fpr28_off * jintSize);  __ fst_d(F29, SP, fpr29_off * jintSize);
  __ fst_d(F30, SP, fpr30_off * jintSize);  __ fst_d(F31, SP, fpr31_off * jintSize);
  __ st_d(T5, SP, t5_off * jintSize);  __ st_d(T6, SP, t6_off * jintSize);
  __ st_d(A0, SP, a0_off * jintSize);  __ st_d(A1, SP, a1_off * jintSize);
  __ st_d(A2, SP, a2_off * jintSize);  __ st_d(A3, SP, a3_off * jintSize);
  __ st_d(A4, SP, a4_off * jintSize);  __ st_d(A5, SP, a5_off * jintSize);
  __ st_d(A6, SP, a6_off * jintSize);  __ st_d(A7, SP, a7_off * jintSize);
  __ st_d(T0, SP, t0_off * jintSize);
  __ st_d(T1, SP, t1_off * jintSize);
  __ st_d(T2, SP, t2_off * jintSize);
  __ st_d(T3, SP, t3_off * jintSize);
  __ st_d(S0, SP, s0_off * jintSize);
  __ st_d(S1, SP, s1_off * jintSize);
  __ st_d(S2, SP, s2_off * jintSize);
  __ st_d(S3, SP, s3_off * jintSize);
  __ st_d(S4, SP, s4_off * jintSize);
  __ st_d(S5, SP, s5_off * jintSize);
  __ st_d(S6, SP, s6_off * jintSize);
  __ st_d(S7, SP, s7_off * jintSize);

  __ st_d(T8, SP, t8_off * jintSize);
  __ st_d(T4, SP, t4_off * jintSize);

  __ st_d(S8, SP, s8_off * jintSize);
  __ st_d(FP, SP, fp_off * jintSize);
  __ st_d(RA, SP, return_off * jintSize);
  __ addi_d(FP, SP, fp_off * jintSize);
...
#define STACK_OFFSET(x) VMRegImpl::stack2reg((x) + additional_frame_slots)
  ...
  map->set_callee_saved(STACK_OFFSET( s8_off), S8->as_VMReg());
...
void RegisterSaver::restore_live_registers(MacroAssembler* masm, bool restore_vectors) {
  __ fld_d(F0, SP, fpr0_off * jintSize); __ fld_d(F1, SP, fpr1_off * jintSize);
  __ fld_d(F2, SP, fpr2_off * jintSize); __ fld_d(F3, SP, fpr3_off * jintSize);
  __ fld_d(F4, SP, fpr4_off * jintSize); __ fld_d(F5, SP, fpr5_off * jintSize);
  __ fld_d(F6, SP, fpr6_off * jintSize);  __ fld_d(F7, SP, fpr7_off * jintSize);
  __ fld_d(F8, SP, fpr8_off * jintSize);  __ fld_d(F9, SP, fpr9_off * jintSize);
  __ fld_d(F10, SP, fpr10_off * jintSize);  __ fld_d(F11, SP, fpr11_off * jintSize);
  __ fld_d(F12, SP, fpr12_off * jintSize);  __ fld_d(F13, SP, fpr13_off * jintSize);
  __ fld_d(F14, SP, fpr14_off * jintSize);  __ fld_d(F15, SP, fpr15_off * jintSize);
  __ fld_d(F16, SP, fpr16_off * jintSize);  __ fld_d(F17, SP, fpr17_off * jintSize);
  __ fld_d(F18, SP, fpr18_off * jintSize);  __ fld_d(F19, SP, fpr19_off * jintSize);
  __ fld_d(F20, SP, fpr20_off * jintSize);  __ fld_d(F21, SP, fpr21_off * jintSize);
  __ fld_d(F22, SP, fpr22_off * jintSize);  __ fld_d(F23, SP, fpr23_off * jintSize);
  __ fld_d(F24, SP, fpr24_off * jintSize);  __ fld_d(F25, SP, fpr25_off * jintSize);
  __ fld_d(F26, SP, fpr26_off * jintSize);  __ fld_d(F27, SP, fpr27_off * jintSize);
  __ fld_d(F28, SP, fpr28_off * jintSize);  __ fld_d(F29, SP, fpr29_off * jintSize);
  __ fld_d(F30, SP, fpr30_off * jintSize);  __ fld_d(F31, SP, fpr31_off * jintSize);

  __ ld_d(T5, SP, t5_off * jintSize);  __ ld_d(T6, SP, t6_off * jintSize);
  __ ld_d(A0, SP, a0_off * jintSize);  __ ld_d(A1, SP, a1_off * jintSize);
  __ ld_d(A2, SP, a2_off * jintSize);  __ ld_d(A3, SP, a3_off * jintSize);
  __ ld_d(A4, SP, a4_off * jintSize);  __ ld_d(A5, SP, a5_off * jintSize);
  __ ld_d(A6, SP, a6_off * jintSize);  __ ld_d(A7, SP, a7_off * jintSize);
  __ ld_d(T0, SP, t0_off * jintSize);
  __ ld_d(T1, SP, t1_off * jintSize);
  __ ld_d(T2, SP, t2_off * jintSize);
  __ ld_d(T3, SP, t3_off * jintSize);
  __ ld_d(S0, SP, s0_off * jintSize);
  __ ld_d(S1, SP, s1_off * jintSize);
  __ ld_d(S2, SP, s2_off * jintSize);
  __ ld_d(S3, SP, s3_off * jintSize);
  __ ld_d(S4, SP, s4_off * jintSize);
  __ ld_d(S5, SP, s5_off * jintSize);
  __ ld_d(S6, SP, s6_off * jintSize);
  __ ld_d(S7, SP, s7_off * jintSize);

  __ ld_d(T8, SP, t8_off * jintSize);
  __ ld_d(T4, SP, t4_off * jintSize);

  __ ld_d(S8, SP, s8_off * jintSize);
  __ ld_d(FP, SP, fp_off * jintSize);
  __ ld_d(RA, SP, return_off * jintSize);
...
void RegisterSaver::restore_result_registers(MacroAssembler* masm) {
  ...
  __ ld_d(V0, SP, a0_off * jintSize);
  __ ld_d(V1, SP, a1_off * jintSize);
  __ addi_d(SP, SP, return_off * jintSize);
}
...
Register AdapterGenerator::arg_slot(const int st_off) {
  Unimplemented();
  return NULL; // eliminating warning
}
...
nmethod *SharedRuntime::generate_native_wrapper(MacroAssembler* masm,
  ...
  if (method->is_static() && !is_critical_native) {
    ...
    __ relocate(rspec);
    __ patchable_set52(oop_handle_reg, (long)JNIHandles::make_local((method->method_holder())->java_mirror()));
  ...
  // argument registers at this point (what if we save/restore them there are no oop?
  {
    ...
    __ relocate(rspec);
    __ patchable_set52(AT, (long)(method()));
...
void SharedRuntime::generate_deopt_blob() {
  ...
  __ st_d(V0, SP, RegisterSaver::v0Offset() * wordSize);
  __ st_d(V1, SP, RegisterSaver::v1Offset() * wordSize);
  __ fst_d(F0, SP, RegisterSaver::fpResultOffset()* wordSize);// Pop float stack and store in local
  __ fst_d(F1, SP, (RegisterSaver::fpResultOffset() + 1) * wordSize);
  ...
  __ ld_d(V0, SP, (RegisterSaver::v0Offset() + additional_words + 1) * wordSize);
  __ ld_d(V1, SP, (RegisterSaver::v1Offset() + additional_words + 1) * wordSize);
  __ fld_d(F0, SP, (RegisterSaver::fpResultOffset() + additional_words + 1) * wordSize);// Pop float stack and store in local
  __ fld_d(F1, SP, (RegisterSaver::fpResultOffset() + additional_words + 2) * wordSize);
  //FIXME,
...
void SharedRuntime::generate_uncommon_trap_blob() {
  ...
  __ st_d(S0, SP, s0_off * BytesPerInt);
  __ st_d(S1, SP, s1_off * BytesPerInt);
  __ st_d(S2, SP, s2_off * BytesPerInt);
  __ st_d(S3, SP, s3_off * BytesPerInt);
  __ st_d(S4, SP, s4_off * BytesPerInt);
  __ st_d(S5, SP, s5_off * BytesPerInt);
  __ st_d(S6, SP, s6_off * BytesPerInt);
  __ st_d(S7, SP, s7_off * BytesPerInt);
  ...
  __ enter();
  __ addi_d(SP, SP, -(framesize / 2 - 2) * wordSize);
...
RuntimeStub* SharedRuntime::generate_resolve_blob(address destination, const char* name) {
  ...
  __ st_ptr(V0, SP, RegisterSaver::t5Offset() * wordSize);
