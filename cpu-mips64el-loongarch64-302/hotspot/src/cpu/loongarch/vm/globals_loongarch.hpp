...
define_pd_global(intx, InlineSmallCode,          4000); // 2016/5/11 Jin: LOONGARCH generates 3x instructions than X86
...
#define ARCH_FLAGS(develop, product, diagnostic, experimental, notproduct) \
  ...
  product(intx, SetFSFOFN, 999,                                             \
          ...
          "=XYZ, with X:FS, Y:FO, Z:FN, X, Y and Z in 0=off, 1=on")         \
                                                                            \
  /* assembler */                                                           \
  product(bool, UseCountLeadingZerosInstructionLOONGARCH64, true,           \
          "Use count leading zeros instruction")                            \
                                                                            \
  product(bool, UseCountTrailingZerosInstructionLOONGARCH64, false,         \
