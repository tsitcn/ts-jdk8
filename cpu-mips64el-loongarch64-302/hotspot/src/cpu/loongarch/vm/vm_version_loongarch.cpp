...
#   define __ _masm->
    ...
    __ li(AT, (long)0);
    __ cpucfg(T5, AT);
    __ ld_w(AT, A0, in_bytes(VM_Version::Loongson_Cpucfg_id0_offset()));
    __ st_w(T5, A0, in_bytes(VM_Version::Loongson_Cpucfg_id0_offset()));

    __ li(AT, 1);
    __ cpucfg(T5, AT);
    __ ld_w(AT, A0, in_bytes(VM_Version::Loongson_Cpucfg_id1_offset()));
    __ st_w(T5, A0, in_bytes(VM_Version::Loongson_Cpucfg_id1_offset()));

    __ li(AT, 2);
    __ cpucfg(T5, AT);
    __ ld_w(AT, A0, in_bytes(VM_Version::Loongson_Cpucfg_id2_offset()));
...
void VM_Version::get_processor_features() {
...
#if 0
  //TODO: LA all loongarch cpus support cpucfg?
  ...
  if (UseCountTrailingZerosInstructionLOONGARCH64) {
    if (!FLAG_IS_DEFAULT(UseCountTrailingZerosInstructionLOONGARCH64))
      warning("ctz/dctz instructions are not available on this CPU");
    FLAG_SET_DEFAULT(UseCountTrailingZerosInstructionLOONGARCH64, 0);
  }
  ...
  jio_snprintf(buf, sizeof(buf), "%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s%s, UseSyncLevel:%d",
