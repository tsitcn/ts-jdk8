...
void TemplateTable::fop2(Operation op) {
  ...
  switch (op) {
    case add:
      __ fld_s(FTF, at_sp());
      __ fadd_s(FSF, FTF, FSF);
      break;
    case sub:
      __ fld_s(FTF, at_sp());
      __ fsub_s(FSF, FTF, FSF);
      break;
    case mul:
      __ fld_s(FTF, at_sp());
      __ fmul_s(FSF, FTF, FSF);
      break;
    case div:
      __ fld_s(FTF, at_sp());
      __ fdiv_s(FSF, FTF, FSF);
      break;
    case rem:
      __ fmov_s(FA1, FSF);
      __ fld_s(FA0, at_sp());
...
void TemplateTable::dop2(Operation op) {
  ...
  switch (op) {
    case add:
      __ fld_d(FTF, at_sp());
      __ fadd_d(FSF, FTF, FSF);
      break;
    case sub:
      __ fld_d(FTF, at_sp());
      __ fsub_d(FSF, FTF, FSF);
      break;
    case mul:
      __ fld_d(FTF, at_sp());
      __ fmul_d(FSF, FTF, FSF);
      break;
    case div:
      __ fld_d(FTF, at_sp());
      __ fdiv_d(FSF, FTF, FSF);
      break;
    case rem:
      __ fmov_d(FA1, FSF);
      __ fld_d(FA0, at_sp());
...
void TemplateTable::convert() {
  ...
  switch (bytecode()) {
    ...
    case Bytecodes::_f2i:
    {
      ...
      __ ftintrz_w_s(F12, FSF);
      __ movfr2gr_s(FSR, F12);
      __ fcmp_cun_s(FCC0, FSF, FSF);    //NaN?
      __ movcf2gr(AT, FCC0);
      __ masknez(FSR, FSR, AT);

      __ move(AT, 0x7fffffff);
      __ bne(AT, FSR, L);

      __ lu12i_w(T4, 0x80000);
      __ movfr2gr_s(AT, FSF);
      __ andr(AT, AT, T4);
    ...
    case Bytecodes::_f2l:
    {
      ...
      __ ftintrz_l_s(F12, FSF);
      __ movfr2gr_d(FSR, F12);
      __ fcmp_cun_s(FCC0, FSF, FSF);    //NaN?
      __ movcf2gr(AT, FCC0);
      __ masknez(FSR, FSR, AT);
    ...
    case Bytecodes::_d2i:
    {
      ...
      __ ftintrz_w_d(F12, FSF);
      __ move(AT, 0x7fffffff);
      __ movfr2gr_s(FSR, F12);

      __ movgr2fr_w(F12, R0);
      __ bne(FSR, AT, L);

      __ ffint_d_w(F12, F12);
      __ fcmp_cult_d(FCC0, FSF, F12);
      __ addi_d(T4, R0, -1);
      __ bceqz(FCC0, L);

      __ fcmp_cun_d(FCC0, FSF, FSF);    //NaN?
      __ sub_w(FSR, T4, AT);
      __ bceqz(FCC0, L);
      __ move(FSR, R0);
...
void TemplateTable::float_cmp(bool is_float, int unordered_result) {
  if (is_float) {
    ...
    if (unordered_result < 0) {
      __ fcmp_clt_s(FCC0, FSF, FTF);
      __ fcmp_cult_s(FCC1, FTF, FSF);
    } else {
      __ fcmp_cult_s(FCC0, FSF, FTF);
      __ fcmp_clt_s(FCC1, FTF, FSF);
    }
  } else {
    __ fld_d(FTF, at_sp());
    __ addi_d(SP, SP, 2 * wordSize);
    ...
    if (unordered_result < 0) {
      __ fcmp_clt_d(FCC0, FSF, FTF);
      __ fcmp_cult_d(FCC1, FTF, FSF);
    } else {
      __ fcmp_cult_d(FCC0, FSF, FTF);
      __ fcmp_clt_d(FCC1, FTF, FSF);
    }
  }
  ...
  if (UseLoopCounter) {
    ...
    if (TieredCompilation) {
      ...
      if (ProfileInterpreter) {
        ...
        if (Assembler::is_simm12(InvocationCounter::InterpreterProfileLimit)) {
        ...
        if (UseOnStackReplacement) {
          if (Assembler::is_simm12(InvocationCounter::InterpreterBackwardBranchLimit)) {
