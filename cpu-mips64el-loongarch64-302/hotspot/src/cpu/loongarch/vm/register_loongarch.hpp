...
// The integer registers of the LOONGARCH32 architecture
...
#define SSR            T6
#define FSF            FV0
//#define SSF            F23 // not use?
#define FTF            F23
//#define STF            F3 // not use?

//#define AFT            F30 // not use?
...
const int LOONGARCH_ARGS_IN_REGS_NUM = 4;
