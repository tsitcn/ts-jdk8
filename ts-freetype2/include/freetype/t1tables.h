...
#define T1_MAX_MM_MAP_POINTS  20
   ...
   *   `FT_TS_Err_Invalid_Argument` error code.
   *
   * @example:
   *   ```
   *     PS_FontInfoRec  font_info;
   *
   *
   *     error = FT_TS_Get_PS_Font_Info( face, &font_info );
   *     ...
   *   ```
   *
   */
   ...
   *   formats this function returns the `FT_TS_Err_Invalid_Argument` error
   *   code.
   *
   * @example:
   *   ```
   ...
   *
   *
   *     error = FT_TS_Get_PS_Font_Private( face, &font_private );
   *     ...
   *   ```
   *
   */
