...
FT_TS_BEGIN_HEADER
   ...
   *    FT_TS_Stroker
   *
   *    FT_TS_Stroker_LineJoin
   *    FT_TS_Stroker_LineCap
   *    FT_TS_StrokerBorder
   *
   *    FT_TS_Outline_GetInsideBorder
   *    FT_TS_Outline_GetOutsideBorder
   *
   *    FT_TS_Glyph_Stroke
   *    FT_TS_Glyph_StrokeBorder
   *
   *    FT_TS_Stroker_New
   *    FT_TS_Stroker_Set
   *    FT_TS_Stroker_Rewind
   *    FT_TS_Stroker_ParseOutline
   *    FT_TS_Stroker_Done
   *
   *    FT_TS_Stroker_BeginSubPath
   *    FT_TS_Stroker_EndSubPath
   *
   *    FT_TS_Stroker_LineTo
   *    FT_TS_Stroker_ConicTo
   *    FT_TS_Stroker_CubicTo
   *
   *    FT_TS_Stroker_GetBorderCounts
   *    FT_TS_Stroker_ExportBorder
   *    FT_TS_Stroker_GetCounts
   *    FT_TS_Stroker_Export
   *
   */
   ...
   */
  typedef struct FT_TS_StrokerRec_*  FT_TS_Stroker;
   ...
   *
   *   FT_TS_STROKER_LINEJOIN_MITER_FIXED ::
   ...
   *     `FT_TS_STROKER_LINEJOIN_MITER_FIXED` generates a miter line join as
   *     used in PostScript and PDF.
   *
   *   FT_TS_STROKER_LINEJOIN_MITER_VARIABLE ::
   *   FT_TS_STROKER_LINEJOIN_MITER ::
   ...
   *     `FT_TS_STROKER_LINEJOIN_MITER_VARIABLE` generates a mitered line join
   *     as used in XPS.  `FT_TS_STROKER_LINEJOIN_MITER` is an alias for
   *     `FT_TS_STROKER_LINEJOIN_MITER_VARIABLE`, retained for backward
   *     compatibility.
   */
  typedef enum  FT_TS_Stroker_LineJoin_
  {
    FT_TS_STROKER_LINEJOIN_ROUND          = 0,
    FT_TS_STROKER_LINEJOIN_BEVEL          = 1,
    FT_TS_STROKER_LINEJOIN_MITER_VARIABLE = 2,
    FT_TS_STROKER_LINEJOIN_MITER          = FT_TS_STROKER_LINEJOIN_MITER_VARIABLE,
    FT_TS_STROKER_LINEJOIN_MITER_FIXED    = 3
   ...
   *
   * @values:
   *   FT_TS_STROKER_LINECAP_BUTT ::
   *     The end of lines is rendered as a full stop on the last point
   *     itself.
   *
   *   FT_TS_STROKER_LINECAP_ROUND ::
   *     The end of lines is rendered as a half-circle around the last point.
   *
   *   FT_TS_STROKER_LINECAP_SQUARE ::
   *     The end of lines is rendered as a square around the last point.
   */
  typedef enum  FT_TS_Stroker_LineCap_
  {
    FT_TS_STROKER_LINECAP_BUTT = 0,
    FT_TS_STROKER_LINECAP_ROUND,
    FT_TS_STROKER_LINECAP_SQUARE
   ...
   *   @FT_TS_Stroker_GetBorderCounts and @FT_TS_Stroker_ExportBorder.
   *
   * @values:
   ...
   *
   *   You can however use @FT_TS_Outline_GetInsideBorder and
   *   @FT_TS_Outline_GetOutsideBorder to get these.
   */
  typedef enum  FT_TS_StrokerBorder_
  {
    FT_TS_STROKER_BORDER_LEFT = 0,
    FT_TS_STROKER_BORDER_RIGHT
   ...
   *
   * @description:
   *   Retrieve the @FT_TS_StrokerBorder value corresponding to the 'inside'
   ...
   *
   * @return:
   *   The border index.  @FT_TS_STROKER_BORDER_RIGHT for empty or invalid
   *   outlines.
   */
  FT_TS_EXPORT( FT_TS_StrokerBorder )
   ...
   *
   * @description:
   *   Retrieve the @FT_TS_StrokerBorder value corresponding to the 'outside'
   *   borders of a given outline.
   *
   * @input:
   *   outline ::
   ...
   *
   * @return:
   *   The border index.  @FT_TS_STROKER_BORDER_LEFT for empty or invalid
   *   outlines.
   */
  FT_TS_EXPORT( FT_TS_StrokerBorder )
   ...
   *   @FT_TS_STROKER_LINEJOIN_MITER_VARIABLE or replaced with a bevel join for
   *   @FT_TS_STROKER_LINEJOIN_MITER_FIXED.
   *
   *   This function calls @FT_TS_Stroker_Rewind automatically.
   */
  FT_TS_EXPORT( void )
   ...
   *   @FT_TS_Stroker_BeginSubPath or @FT_TS_Stroker_EndSubPath.
   *
   * @input:
   *   stroker ::
   *     The target stroker handle.
   ...
   *   @FT_TS_Stroker_GetCounts and @FT_TS_Stroker_Export.
   *
   * @input:
   *   stroker ::
   *     The target stroker handle.
   ...
   *   stored as an @FT_TS_Outline object.
   */
  FT_TS_EXPORT( FT_TS_Error )
   ...
   *
   * @note:
   *   You should call this function after @FT_TS_Stroker_BeginSubPath.  If the
   ...
   *
   * @note:
   *   You should call this function between @FT_TS_Stroker_BeginSubPath and
   *   @FT_TS_Stroker_EndSubPath.
   */
  FT_TS_EXPORT( FT_TS_Error )
   ...
   *
   *   Use the function @FT_TS_Stroker_GetCounts instead if you want to retrieve
   ...
   *
   * @description:
   *   Call this function after @FT_TS_Stroker_GetBorderCounts to export the
   *   corresponding border to your own @FT_TS_Outline structure.
   *
   ...
   *
   * @note:
   *   Always call this function after @FT_TS_Stroker_GetBorderCounts to get
   *   sure that there is enough room in your @FT_TS_Outline object to receive
   *   all new data.
   *
   *   When an outline, or a sub-path, is 'closed', the stroker generates two
   *   independent 'border' outlines, named 'left' and 'right'.
   ...
   *   while the 'right' border becomes empty.
   *
   *   Use the function @FT_TS_Stroker_Export instead if you want to retrieve
   *   all borders at once.
   */
  FT_TS_EXPORT( void )
   ...
   *
   * @description:
   *   Call this function after @FT_TS_Stroker_GetBorderCounts to export all
   *   borders to your own @FT_TS_Outline structure.
   *
   *   Note that this function appends the border points and contours to your
   *   outline, but does not try to resize its arrays.
   *
