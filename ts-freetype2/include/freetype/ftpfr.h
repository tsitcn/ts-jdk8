...
FT_TS_BEGIN_HEADER
   ...
   *    This is unlike @FT_TS_Get_Kerning with the @FT_TS_KERNING_UNSCALED mode,
   *    which always returns distances converted to outline units.
   *
   *    You can use the value of the `x_scale` and `y_scale` parameters
   *    returned by @FT_TS_Get_PFR_Metrics to scale these to device subpixels.
   */
  FT_TS_EXPORT( FT_TS_Error )
   ...
   *
   * @note:
   *    You can use the `x_scale` or `y_scale` results of @FT_TS_Get_PFR_Metrics
