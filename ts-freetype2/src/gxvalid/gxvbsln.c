...
#define FT_TS_COMPONENT  gxvbsln
...
#define GXV_BSLN_VALUE_EMPTY  0xFFFFU
  ...
  {
    FT_TS_Bytes   ctlPoints_p;
    FT_TS_UShort  defaultBaseline;
...
#define GXV_BSLN_DATA( field )  GXV_TABLE_DATA( bsln, field )
  ...
  static void
  gxv_bsln_LookupValue_validate( FT_TS_UShort            glyph,
                                 GXV_LookupValueCPtr  value_p,
                                 GXV_Validator        gxvalid )
  {
    FT_TS_UShort     v = value_p->u;
    FT_TS_UShort*    ctlPoints;
    ...
    ctlPoints = (FT_TS_UShort*)GXV_BSLN_DATA( ctlPoints_p );
  ...
  */
  ...
  gxv_bsln_LookupFmt4_transit( FT_TS_UShort            relative_gindex,
  ...
  static void
  gxv_bsln_parts_fmt0_validate( FT_TS_Bytes       tables,
                                FT_TS_Bytes       limit,
                                GXV_Validator  gxvalid )
  {
    FT_TS_Bytes  p = tables;
  ...
  static void
  gxv_bsln_parts_fmt1_validate( FT_TS_Bytes       tables,
                                FT_TS_Bytes       limit,
                                GXV_Validator  gxvalid )
  {
    FT_TS_Bytes  p = tables;
  ...
  static void
  gxv_bsln_parts_fmt2_validate( FT_TS_Bytes       tables,
                                FT_TS_Bytes       limit,
                                GXV_Validator  gxvalid )
  {
    FT_TS_Bytes   p = tables;

    FT_TS_UShort  stdGlyph;
    FT_TS_UShort  ctlPoint;
    FT_TS_Int     i;

    FT_TS_UShort  defaultBaseline = GXV_BSLN_DATA( defaultBaseline );
  ...
  static void
  gxv_bsln_parts_fmt3_validate( FT_TS_Bytes       tables,
                                FT_TS_Bytes       limit,
                                GXV_Validator  gxvalid)
  {
    FT_TS_Bytes  p = tables;
  ...
  gxv_bsln_validate( FT_TS_Bytes      table,
                     FT_TS_Face       face,
                     FT_TS_Validator  ftvalid )
  {
    ...
    FT_TS_TRACE3(( "validating `bsln' table\n" ));
    GXV_INIT;
    ...
    defaultBaseline = FT_TS_NEXT_USHORT( p );
