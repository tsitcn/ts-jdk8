...
public abstract class SunFontManager implements FontSupport, FontManagerForSGE {
    ...
    private String[][] jreFontArray = new String[][] {
            /* Lucida Sans Family */
            {"lucida sans0",                     "LucidaSansRegular.ttf"      },
            {"lucida sans1",                     "LucidaSansDemiBold.ttf"     },
            /* Lucida Sans full names (map Bold and DemiBold to same file) */
            {"lucida sans regular0",             "LucidaSansRegular.ttf"      },
            {"lucida sans regular1",             "LucidaSansDemiBold.ttf"     },
            {"lucida sans bold1",                "LucidaSansDemiBold.ttf"     },
            {"lucida sans demibold1",            "LucidaSansDemiBold.ttf"     },

            /* Lucida Sans Typewriter Family */
            {"lucida sans typewriter0",          "LucidaTypewriterRegular.ttf"},
            {"lucida sans typewriter1",          "LucidaTypewriterBold.ttf"   },
            /* Typewriter full names (map Bold and DemiBold to same file) */
            {"lucida sans typewriter regular0",  "LucidaTypewriter.ttf"       },
            {"lucida sans typewriter regular1",  "LucidaTypewriterBold.ttf"   },
            {"lucida sans typewriter bold1",     "LucidaTypewriterBold.ttf"   },
            {"lucida sans typewriter demibold1", "LucidaTypewriterBold.ttf"   },

            /* Lucida Bright Family */
            {"lucida bright0",                   "LucidaBrightRegular.ttf"    },
            {"lucida bright1",                   "LucidaBrightDemiBold.ttf"   },
            {"lucida bright2",                   "LucidaBrightItalic.ttf"     },
            {"lucida bright3",                   "LucidaBrightDemiItalic.ttf" },
            /* Lucida Bright full names (map Bold and DemiBold to same file) */
            {"lucida bright regular0",           "LucidaBrightRegular.ttf"    },
            {"lucida bright regular1",           "LucidaBrightDemiBold.ttf"   },
            {"lucida bright regular2",           "LucidaBrightItalic.ttf"     },
            {"lucida bright regular3",           "LucidaBrightDemiItalic.ttf" },
            {"lucida bright bold1",              "LucidaBrightDemiBold.ttf"   },
            {"lucida bright bold3",              "LucidaBrightDemiItalic.ttf" },
            {"lucida bright demibold1",          "LucidaBrightDemiBold.ttf"   },
            {"lucida bright demibold3",          "LucidaBrightDemiItalic.ttf" },
            {"lucida bright italic2",            "LucidaBrightItalic.ttf"     },
            {"lucida bright italic3",            "LucidaBrightDemiItalic.ttf" },
            {"lucida bright bold italic3",       "LucidaBrightDemiItalic.ttf" },
            {"lucida bright demibold italic3",   "LucidaBrightDemiItalic.ttf" }
        };
    ...
    private void initJREFontMap() {
        ...
        for (String[] item : jreFontArray)
        {
            jreFontMap.put(item[0], item[1]);
        }
