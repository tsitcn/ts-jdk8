...
#ifndef TS_JDK8_LOG_FILE

#define TS_JDK8_LOG_FILE              "tsjdk8.log"
#if defined(_WINDOWS) || defined(WIN32)
#define __FUNC__    __FUNCTION__
#define TS_JDK8_LOG_FILE_PATH         "d:\\"  TS_JDK8_LOG_FILE
#else
#define __FUNC__    __func__
#define TS_JDK8_LOG_FILE_PATH         "/tmp/" TS_JDK8_LOG_FILE
#endif
...
#define LOG_TO_FILE(FMT, ...)   {LOG_TEXT_ONLY(FMT, ##__VA_ARGS__) \
                                {FILE* log_fp = fopen(TS_JDK8_LOG_FILE_PATH, "a+"); \
