...
#ifdef __mips__
//These defs in glibc2.12 and glibc2.20 are different.
// jdk compiled by glibc2.12 may cause error, when running on glibc2.20
// After the bug in glibc2.12 is fixed, codes below can be deleted
// see jdk/src/solaris/native/java/util/FileSystemPreferences.c
