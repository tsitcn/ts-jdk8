...
/*
 * This file has been modified by Loongson Technology in 2014. These
 * modifications are Copyright (c) 2014 Loongson Technology, and are made
...
#ifdef __mips__
    /* 2013/11/15 Jin: mips should not executes the following checking.
     *    Such checking will disable xrender for all Linux < 3.5.
     */
    return available;
#endif
