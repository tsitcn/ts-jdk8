...
public abstract class Graphics2D extends Graphics {
    ...
    protected boolean mFontBitmapFirst;
    ...
    public void setFontBitmapFirst(boolean first)
    {
        if (mFontBitmapFirst != first)
        {
            mFontBitmapFirst = first;
        }
    }
    
    public boolean getFontBitmapFirst()
    {
        return mFontBitmapFirst;
    }
