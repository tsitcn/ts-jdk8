...
public final class TextAttribute extends Attribute {
    ...
    /**
     * values for Bold/Italic(Posture), use taishan office default.
     */
    public static final TextAttribute OFFICE_STYLE   =
        new TextAttribute("office_style");

    public static final TextAttribute POSTURE_OFFICE =
        new TextAttribute("posture_office");
    public static final Float POSTURE_OBLIQUE        =
        Float.valueOf(0.20F);
    public static final Float POSTURE_OBLIQUE_OFFICE =
        Float.valueOf(0.35F);

    /**
     * This is relative direction.
     */
     
    public static final TextAttribute POSTURE_DIRECTION  =
        new TextAttribute("posture_direction");
    public static final Boolean POSTURE_DIRECTION_RIGHT  =
        Boolean.FALSE;
    public static final Boolean POSTURE_DIRECTION_BOTTOM =
        Boolean.TRUE;


    public static final Float WEIGHT_BOLD_OFFICE_X   = WEIGHT_BOLD;

    public static final Float WEIGHT_BOLD_OFFICE_Y   = WEIGHT_MEDIUM;

    public static final TextAttribute WEIGHT_X       =
        new TextAttribute("weight_x");

    public static final TextAttribute WEIGHT_Y       =
        new TextAttribute("weight_y");


    public static final TextAttribute SOLID_SIZE     =
        new TextAttribute("solid_size");
    public static final Boolean SOLID_SIZE_DISABLE   =
        Boolean.FALSE;
    public static final Boolean SOLID_SIZE_ENABLE    =
        Boolean.TRUE;

    public static final TextAttribute SOLID_SIZE_X   =
        new TextAttribute("solid_size_x");
    public static final Boolean SOLID_SIZE_X_DISABLE =
        Boolean.FALSE;
    public static final Boolean SOLID_SIZE_X_ENABLE  =
        Boolean.TRUE;

    public static final TextAttribute SOLID_SIZE_Y   =
        new TextAttribute("solid_size_y");
    public static final Boolean SOLID_SIZE_Y_DISABLE =
        Boolean.FALSE;
    public static final Boolean SOLID_SIZE_Y_ENABLE  =
        Boolean.TRUE;
    ...
    public static final Boolean BITMAP_BOLD_GRAY_DISABLE =
        Boolean.FALSE;
    public static final Boolean BITMAP_BOLD_GRAY_ENABLE  =
        Boolean.TRUE;

    public static final TextAttribute BITMAP_BOLD_GRAY_NORTH =
        new TextAttribute("bitmap_bold_gray_north");
    public static final Boolean BITMAP_BOLD_GRAY_NORTH_DISABLE =
        Boolean.FALSE;
    public static final Boolean BITMAP_BOLD_GRAY_NORTH_ENABLE  =
        Boolean.TRUE;

    public static final TextAttribute BITMAP_BOLD_GRAY_EAST =
        new TextAttribute("bitmap_bold_gray_east");
    public static final Boolean BITMAP_BOLD_GRAY_EAST_DISABLE =
        Boolean.FALSE;
    public static final Boolean BITMAP_BOLD_GRAY_EAST_ENABLE  =
        Boolean.TRUE;
        
    public static final TextAttribute BITMAP_BOLD_GRAY_SORTH =
        new TextAttribute("bitmap_bold_gray_sorth");
    public static final Boolean BITMAP_BOLD_GRAY_SORTH_DISABLE =
        Boolean.FALSE;
    public static final Boolean BITMAP_BOLD_GRAY_SORTH_ENABLE  =
        Boolean.TRUE;

    public static final TextAttribute BITMAP_BOLD_GRAY_WEST =
        new TextAttribute("bitmap_bold_gray_west");
    public static final Boolean BITMAP_BOLD_GRAY_WEST_DISABLE =
        Boolean.FALSE;
    public static final Boolean BITMAP_BOLD_GRAY_WEST_ENABLE  =
        Boolean.TRUE;

    /**
     * flip
     */
    public static final TextAttribute FLIP_L2R   =
        new TextAttribute("flip_l2r");
    public static final Boolean FLIP_L2R_DISABLE =
        Boolean.FALSE;
    public static final Boolean FLIP_L2R_ENABLE  =
        Boolean.TRUE;

    public static final TextAttribute FLIP_T2B   =
        new TextAttribute("flip_t2b");
    public static final Boolean FLIP_T2B_DISABLE =
        Boolean.FALSE;
    public static final Boolean FLIP_T2B_ENABLE  =
        Boolean.TRUE;
