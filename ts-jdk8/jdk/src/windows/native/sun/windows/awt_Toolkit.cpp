...
/**
 * At windows OS, when drop some files, InvokeInputMethodFunction would block to die.
 * We use timeout to avoid it.
 */
#define INPUTMETHOD_TIMEOUT_FLAG
#define INPUTMETHOD_TIMEOUT_MS          5000
...
#ifdef INPUTMETHOD_TIMEOUT_FLAG
        	  switch (msg)
        	  {
        	      //0x9814 
        	      case WM_AWT_ASSOCIATECONTEXT:
        	      ...
        	      case WM_AWT_ENDCOMPOSITION:
        	  	  //0x9824
        	      case WM_AWT_OPENCANDIDATEWINDOW:
        	      	timeout = INPUTMETHOD_TIMEOUT_MS;
        	      	break;
...
#endif
            ::WaitForSingleObject(m_inputMethodWaitEvent, timeout);
            return m_inputMethodData;
        }
        return 0;
    }
