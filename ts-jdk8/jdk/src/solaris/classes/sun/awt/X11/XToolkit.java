...
public final class XToolkit extends UNIXToolkit implements Runnable {
    ...
    private static String taskbarGroupName = null;
    ...
    * XSETTINGS for the default screen.
    ...
    @Override
    public void setTaskbarGroupName(final String name)
    {
        taskbarGroupName = name;
    }

    static String getTaskbarGroupName()
    {
        return (taskbarGroupName != null ? taskbarGroupName : awtAppClassName);
    }
