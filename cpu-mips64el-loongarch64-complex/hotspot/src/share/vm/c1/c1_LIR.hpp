...
#endif
#if defined(SPARC) || defined(ARM) || defined(PPC) || defined(AARCH64) || defined(MIPS) || defined(LOONGARCH)
...
#if defined(X86) || defined(ARM) || defined(AARCH64) || defined(MIPS) || defined(LOONGARCH)
...
# include C1_LIR_MD_HPP
  ...
  static LIR_Opr double_softfp(int reg1, int reg2) { return (LIR_Opr)((reg2 << LIR_OprDesc::reg1_shift)        |
                                                                             ...
                                                                             LIR_OprDesc::cpu_register         |
                                                                             LIR_OprDesc::double_size); }
#elif defined(MIPS) || defined(LOONGARCH)
  static LIR_Opr double_fpu(int reg)            { return (LIR_Opr)(intptr_t)((reg  << LIR_OprDesc::reg1_shift) |
                                                                             (reg  << LIR_OprDesc::reg2_shift) |
                                                                             LIR_OprDesc::double_type          |
                                                                             LIR_OprDesc::fpu_register         |
